...
[theta, PlotSFlow, circle, ~, totalSFlow] = plotShearFlow(shearYieldStress);
                ...
                % title('Stringer Positions Around Fuselage');
                ...
                title('Shear Flow Distribution Around Fuselage', FontSize=25,fontname='Cambria Math');
                grid on;
                legend('Shear Flow', 'Fuselage', 'Location', 'best', FontSize=18);
